...
// import 'package:BabanaExpress/presentation/components/Widget/k_home_info%20copy.dart';
...
//                     PharmacyState>(
//                 listener: (context, state) {
//                   if (state.isLoadedHistoriqueLivraison == 0) {
//                     rotation();
//                   } else {
//                     stopRotation();
//                   }
...
//                                       ).add(EdgeInsets.only(
//                                         bottom:
//                                             state.index == 2 ? 0 : kMarginY * 3,
//                                         right: kMarginX,
//                                       )),
//                                       // padding: EdgeInsets.only(
//                                       //   top: state.index == 2 ? kMarginY : kMarginY * 3,
//                                       // ),
//                                       child: KHomeInfoS(user: state.user)),
//                                   if (state.index == 2)
//                                     Container(
//                                         margin: EdgeInsets.only(
//                                           top: kMarginY * 2,
