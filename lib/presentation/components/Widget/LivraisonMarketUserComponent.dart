...
class LivraisonMarketUserComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) { 
    ...
    return livraison.produits.length == 0
        ? Container()
        : livraison.produits[0].images.length == 0
            ? Container()
            : InkWell(
                child: Container(
                ...
                onTap: () => AutoRouter.of(context)
                    .push(LivraisonMarketDataRoute(livraison: livraison)));
  }
}
