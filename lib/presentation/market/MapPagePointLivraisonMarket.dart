...
@RoutePage()
class MapPagePointLivraisonMarket extends StatefulWidget {
  static const routeName = '/livraison/market';
  @override
  State<MapPagePointLivraisonMarket> createState() =>
      _MapPagePointLivraisonMarketState();
}

class _MapPagePointLivraisonMarketState
    extends State<MapPagePointLivraisonMarket> {
  ...
  validatePoint()  =>
    GlobalBottomSheet.show(
        ...
        subtitle: 'Valider les informations de votre point de livraison'.tr(),
