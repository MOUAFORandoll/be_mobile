  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LivraisonBloc, LivraisonState>(
      ...
      return SingleChildScrollView(
        ...
        SizedBox(
            height: state.listColis!.length == 0 ? 0 : getHeight(context) * .65,
                          ...
                          child: DropdownButton(
                            ...
                            onChanged: (CategoryModel? newValue) {
                              context.read<LivraisonBloc>().add(
                                  SelectedCategory(categoryColis: newValue!));
                            },
                            items: state.list_category_colis!.map((value) {
                              ...
                              children: [
                                (!state.isMapSelectedPointLivraison)
                                    ? Container(
                                        ...
                                        alignment: Alignment.center,
                                        child:
                                            DropdownButton<PointLivraisonModel>(
                                          isExpanded: true,
