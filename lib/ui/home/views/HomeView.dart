...
import 'package:BananaExpress/ui/home/bloc/home_event.dart';
...
class _HomeViewState extends State<HomeView> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(builder: (context, state) {
      InitialDataState _controleState = state as InitialDataState;
      InitialDataState _userState = _controleState;
      return Scaffold(
          backgroundColor: ColorsApp.bg,
          drawer: CustomDrawer(),
          body: SafeArea(
              child:
                  _userState.user.typeUser == 2 || _userState.user.typeUser == 1
                      ? Text('a') /* SimpleUserView() */
                      : Text('b') /*  BabanaView() */),
