...
class LivraisonState with _$LivraisonState {
  const factory LivraisonState({
    ...
    required bool isCurrentlyDelivery,
    int? isLoadEmplacementInfo,
    MapPlaceInfoModel? recuperationPlaceInfo,
    MapPlaceInfoModel? livraisonPlaceInfo,
  }) = _LivraisonState;

  factory LivraisonState.initial() => LivraisonState(
        isLoadEmplacementInfo: null,
        livraisonPlaceInfo: null,
        recuperationPlaceInfo: null,
